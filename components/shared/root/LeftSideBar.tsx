...
const LeftSideBar = () => {
  ...
  return (
    <aside
      className="background-light900_dark200 custom-scrollbar sticky inset-y-0 flex h-screen min-w-[80px]     flex-col overflow-y-auto border-none
          ...
          return (
            <Link
              ...
              className={`flex h-full w-full
                gap-4 rounded-lg font-montserrat text-base max-lg:p-4 lg:p-4  ${
            ...
            >
              ...
              />
              <span className="max-lg:hidden max-sm:text-xs">{link.label}</span>
            </Link>
          );
        })}
      </div>
