...
const LeftSideBar = () => {
  ...
  return (
    <aside
      className="background-light900_dark200 custom-scrollbar sticky inset-y-0 flex h-screen  flex-col overflow-y-scroll pt-20
          ...
          return (
            <Link
              ...
              className={`flex gap-4 rounded-lg
                font-montserrat text-lg max-md:p-4 md:p-5 ${
